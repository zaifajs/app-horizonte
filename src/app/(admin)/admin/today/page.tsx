    ...
    <div className="space-y-6">
      ...
      <section className="flex items-end justify-between gap-6 flex-wrap">
        <div>
          ...
          <h1
            className="font-display text-[44px] leading-[1.05] font-medium mt-1.5"
          ...
          <p className="mt-2 text-[15px] hz-mono" style={{ color: "var(--hz-ink-2)" }}>
            {overdue.length > 0 ? (
              <>
      ...
      <section className="hz-card overflow-hidden">
        <div className="grid grid-cols-2 md:grid-cols-4 grid-cells">
          <div>
            <div className="text-[12px] hz-mono uppercase tracking-[.16em]" style={{ color: "var(--hz-ink-3)" }}>
              Active students
            </div>
            <div className="mt-2 flex items-baseline gap-2">
              <span className="stat-num text-[44px]" style={{ color: "var(--hz-ink)" }}>
                {activeStudentCount}
              </span>
              {newActiveLastWeek > 0 ? (
            ...
            <div className="mt-1 text-[13px] hz-mono" style={{ color: "var(--hz-ink-3)" }}>
          ...
          <div>
            ...
            <div className="mt-1 flex items-center gap-1 text-[12px] hz-mono flex-wrap">
          ...
          <div>
            ...
            <div className="mt-2 flex items-baseline gap-1">
              <span className="hz-mono text-[18px]" style={{ color: "var(--hz-ink-3)" }}>
                €
              </span>
              <span className="stat-num text-[44px]" style={{ color: "var(--hz-ink)" }}>
          ...
          <div style={overdue.length > 0 ? { background: "var(--hz-danger-50)" } : undefined}>
            ...
            <div className="mt-1 text-[13px] hz-mono" style={{ color: "var(--hz-ink-2)" }}>
              {oldestOverdueDays > 0
      ...
      <div className="grid gap-5" style={{ gridTemplateColumns: "minmax(0, 1.55fr) minmax(0, 1fr)" }}>
        ...
        <section className="hz-card overflow-hidden">
          ...
          {overdue.length === 0 ? (
            <div className="px-4 py-10 text-center text-[14px] hz-mono" style={{ color: "var(--hz-ink-3)" }}>
              No overdue payments. Nice.
            </div>
          ) : (
            <>
              <div
                className="grid grid-cols-12 gap-3 px-4 py-2 hair-b text-[12px] hz-mono uppercase tracking-[.14em]"
                style={{ color: "var(--hz-ink-3)" }}
              >
                    ...
                    >
                      <div className="col-span-5 flex items-center gap-3 min-w-0">
                        ...
                        <Link
                          ...
                          className="min-w-0"
                        >
                          <div className="font-semibold text-[15px] truncate" style={{ color: "var(--hz-ink)" }}>
                            {r.studentName}
                          </div>
                          <div className="text-[13px] hz-mono" style={{ color: "var(--hz-ink-3)" }}>
                            {installmentLabel} · invoiced {format(r.deadlineDate, "yyyy-MM-dd")}
                          </div>
                        </Link>
                      </div>
                      <div className="col-span-2 hz-mono text-[14px]" style={{ color: "var(--hz-primary)" }}>
                        {r.batchCode}
                      </div>
                      <div className="col-span-2 hz-mono font-semibold text-[16px]" style={{ color: "var(--hz-ink)" }}>
                        €{(r.due / 100).toFixed(2)}
                      </div>
        ...
        <div className="flex flex-col gap-5">
          ...
          <section className="hz-card overflow-hidden">
            ...
            {expiringStudents.length === 0 ? (
              <div className="px-4 py-6 text-center text-[14px] hz-mono" style={{ color: "var(--hz-ink-3)" }}>
                  ...
                  return (
                    ...
                    >
                      ...
                      <Link href={`/admin/students/${s.id}`} className="flex-1 min-w-0">
                        ...
                        <div className="text-[13px] mt-0.5 hz-mono" style={{ color: "var(--hz-ink-3)" }}>
                    ...
                    >
                      ...
                      <Link href={`/admin/students/${r.studentId}`} className="flex-1 min-w-0">
                        <div className="flex items-center gap-2">
                          <span className="font-semibold text-[15px] truncate" style={{ color: "var(--hz-ink)" }}>
                            {r.studentName}
                          </span>
          ...
          {recentAudit.length > 0 ? (
            <section className="hz-card p-4">
              <div className="flex items-center gap-2 mb-3">
                ...
                <span className="ml-auto text-[12px] hz-mono" style={{ color: "var(--hz-ink-3)" }}>
                  last 24h
                </span>
              </div>
              <ul className="space-y-1.5 text-[13px] hz-mono" style={{ color: "var(--hz-ink-2)" }}>
